package org.swtk.dl4j.w2v.generic.util;
...
public class WordVectorUtils {
	...
	public static LogManager logger = new LogManager(WordVectorUtils.class);

	public static void nearest(WordVectors vec, String term, int n) {
		Collection<String> list = vec.wordsNearest(term, n);
		logger.info("Nearest Words Result (term = %s, n = %s, nearest = %s)", term, n, WordVectorUtils.toString(list));
	}
